...
abstract class listnotification extends base
{
    ...
    protected final function get_contents() {
        ...
        return <<<HTML5
        <button class="alert-link collapsed close" role="button" data-toggle="collapse" href="#notification{$this->id}" aria-expanded="false" aria-controls="notification{$this->id}">
